...
export default function AdminUsers() {
  // UPDATED: Remove hard-coded departments and add departments state
  ...
  // ADDED: Fetch departments from database
  ...
  const fetchUsersByRole = async (selectedRole) => {
    ...
    try {
      ...
      try {
        ...
        const filteredByRole = allUsersResponse.data.filter(
        ...
        alert(
          "Failed to fetch users: " +
            (fallbackError.response?.data?.message || "Server Error")
        );
      }
    } finally {
      setLoading(false);
  ...
  useEffect(() => {
    ...
    if (activeDepartment !== "all") {
      filtered = filtered.filter(
        (user) => user.department === activeDepartment
      );
    }
  ...
  // UPDATED: Load users and departments on component mount
  useEffect(() => {
    fetchAllUsers();
    fetchDepartments();
  }, []);
    ...
    if (window.confirm(confirmMessage)) {
      try {
        ...
        if (response.data.success) {
          alert(
            `User ${response.data.deletedUser.firstName} ${response.data.deletedUser.lastName} deleted successfully.`
          );
  ...
  return (
    <div className="admin-users-page">
      ...
      <div className="page-container">
        ...
        {/* UPDATED: Department filter with database departments */}
        {(activeRole === "student" ||
          activeRole === "lecturer" ||
          activeRole === "all") && (
          <div className="filter-section">
          ...
          <div className="modal-overlay">
            <div className="modal-content">
              ...
              <form onSubmit={handleSubmit}>
                ...
                {/* UPDATED: Department dropdown with database departments */}
                {role !== "admin" && (
                  <div className="form-group">
          ...
          <div className="modal-overlay">
            <div className="modal-content">
              ...
              <form onSubmit={handleUpdateUser}>
                ...
                {/* UPDATED: Department dropdown with database departments for edit modal */}
